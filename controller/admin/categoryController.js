...
const getCategory = async (req, res) => {
    try {
        ...
        const category = await categoryCollection.find().skip(startIndex).limit(perPage);
...
const addCategory=(req,res)=>{
    try {
        res.render("admin/addCategory",{menu:"categories",categoryStatus:"new"})
    } catch (error) {
        console.log(Error)
    }
}
...
module.exports = {
    ...
    postAddCategory,
    getBlockCategory,
    addCategory,editCategory,editCategoryPost,
    checkCategoryExists
};
