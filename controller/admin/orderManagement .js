...
const getOrderManagement=async (req, res) => {
    try {
        const orders = await OrderDatabase.find().populate('orderedItems.productId');
...
const postOrderManagement=async (req, res) => {
    try {
        ...
        const validStatuses = ['Pending', 'Shipped', 'Processing', 'Delivered', 'Cancelled', 'Returned'];
...
module.exports={
    getOrderManagement,postOrderManagement
}